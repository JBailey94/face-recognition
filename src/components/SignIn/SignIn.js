            ...
            <article className="br3 ba dark-gray b--black-10 mv4 w-100 w-50-m w-25-l mw5 shadow-5 center">
                <main className="pa4 black-80">
                    <div className="measure">
                        ...
                        <div className="">
                        <input 
                            className="b ph3 pv2 input-reset ba b--transparent bg-transparent grow pointer f6 dib white"
                            type="submit" 
                            value="Sign in"
                            onClick={this.onSubmitSignIn} // looks for a callback, arrow function gives it
                        />
                        </div>
